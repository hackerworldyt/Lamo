...
class Config(object):
    ...
    TOKEN = "2116606071:AAFPlSD7XedE2R2qop4-YaktS0Cvwan3kuM"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgresql://kdftqkpy:olxFF5ptYklkAO1oLzkkeC3jmjO3xFU-@kesavan.db.elephantsql.com/kdftqkpy"
    LOAD = []

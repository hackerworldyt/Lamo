...
class Config(object):
    ...
    API_HASH = "awoo"
    TOKEN = "5092248582:AAGyBKR2DhrOgUGvkC4LE5W_XwvSGqxQDHo"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SUPPORT_CHAT = "villanevil_support"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001488032952
